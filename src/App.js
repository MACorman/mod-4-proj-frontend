    ...
    return (
      <div className="App">
        ...
        <Switch>
          ...
          <Route exact path='/signup' render={routerProps => <SignUp currentUser={this.state.currentUser} addUser={this.addUser} logUserIn={this.logUserIn} {...routerProps} />} />
